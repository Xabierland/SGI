...
> El cliclo PDCA o circulo de Shewhart es un metodo de mejora continua de la calidad basado en 4 pasos: Planificar, Hacer, Comprobar y Actuar.

> Planificar: Definir el area de mejora, tomar datos, establecer las acciones, los objetivos y tomar indicadores.

> Hacer: Aplicar el plan y verificar su correcta aplicacion.

> Comprobar: Verificar los resultados obtenidos.

> Ajustar: Modificar los enfoques erroneos, estandarizar los procesos correctos, formar a los interesados en los cambios y volver a planificar
...
> Control de calidad: Conjunto de tecnicas y actividades que se llevan a cabo para evaluar la calidad de un producto o servicio.

> Aseguramiento de la calidad: Conjunto de actividades planificadas y sistemáticas implementadas dentro del sistema de calidad y demostradas como necesarias para proporcionar la confianza adecuada de que una entidad cumplira con los requisitos para la calidad.

> Calidad EFQM: Grado en que la organizacion satisface las necesidades de todos los grupos de interes.
...
5. Citar los conceptos fundamentales de la excelencia y elegir uno para desarrollar.

> Los conceptos fundamentales de la excelencia son: Orientado a resultados, orientado a clientes, liderazgo, gestion por procesos y hechos, desarrollo e implicacion de las personas, mejora continua, desarrollo de alianzas, responsabilidad social.

> El concepto que voy a desarrollar es el de desarrollo de alianzas. Dado que las organizaciones se necesitan unas a otras para optimizar, crecer y mejorar la produccion, es necesario establecer alianzas con otras organizaciones para conseguir los objetivos.
...
> La revision por la direccion se basa en los resultados de las auditorias, retroalimentacion del cliente, desempeño de procesos y conformidad de productos, estado de las acciones correctivas y preventivas, seguimiento de revisiones de direccion previas, cambios en el sistema de calidad, recomendaciones para la mejora, acciones para mejorar el sistema de gestion y sus procesos, mejora del producto en relacion con los requisitos de los clientes y acciones sobre la necesidad de recursos.
...
> Impacto: Efecto producido sobre el medio ambiente.

> Para evaluar los aspectos hay que tener en cuenta la magnitud como el valor absoluto del impacto, la intensidad en funcion del peligro, duracion y frecuencia ademas de otros criterios como la toxicidad, la capacidad del medio para absorbe el impacto, la extension del impacto dentro del area o el acercamiento a los limites legales.
...
> Manual de calidad: Documento que describe el sistema de gestion de una organizacion.
> Procedimiento: Documento que describe como se debe realizar una tarea.
> Instruccion tecnica: Documento que describe como se debe realizar una tarea de forma mas detallada que un procedimiento.
> Registro: Documento que cumplimenta un hecho que ha sucedido.
...
> Subcriterios: Partners y proveedores, gestion economica financiera, mantenimiento, tecnologia y conocimiento.

> Partners y proveedores: Establecer relaciones con los proveedores y partners para conseguir los objetivos de la organizacion.
...
> Formacion, Preparacion del paseo, paseo, analisis de las mejoras, ejecucion de acciones de mejora, acciones de consolidacion y indicadores.

5. En la norma ISO 9001-2015, explicar que es la auditoria interna y como se lleva a cabo, requisitos y caracteristicas.

> La auditoria interna es una herramienta de gestion que permite a una organizacion evaluar la eficacia de su sistema de gestion de la calidad.

> Hay que planificar, realizarla personal cualificado, dejar claras las no conformidades, realizar un plan de acciones de mejora para las no conformidades.
...
> Liderazgo: Definir y articular la mision, vision y valores de la organizacion. Definen, revisan e impulsan tanto la mejora del sistema de gestion como su rendimiento. Se implican con los grupos de interes. Refuerzan una cultura de excelencia entre las personas y la organizacion. Se aseguran de que la organizacion sea flexible y gestionan el cambio de manera eficaz.

> Subcriterio: Los lideres se implican con los grupos de interes. Saben cuales son y se enfocan para entender y anticipar sus necesidades y expectativas. Desarrollan iniciativas para implicar partners, clientes y sociedad. Utilizan la innovacion para mejorar la reputacion de la organizacion y atraer clientes, partners y talento. Identifican alianzas estrategicas y operativas.
...
> El aseguramiento de la calidad es un concepto mas amplio que el control de calidad, ya que el aseguramiento de la calidad se encarga de todo el proceso de produccion y el control de calidad solo se encarga de la calidad del producto.
...
> Las claves del concepto de calidad son: Orientado a resultados, orientado a clientes, liderazgo, gestion por procesos y hechos, desarrollo e implicacion de las personas, mejora continua, desarrollo de alianzas, responsabilidad social.

2. ¿Cuales dirias que son las caracteristicas principales de los indicadores estrategicos?

> Los indicadores estrategicos son indicadores que se utilizan para medir el rendimiento de la organizacion en relacion con los objetivos estrategicos.
